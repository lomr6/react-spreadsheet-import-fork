...
type UploadProps = {
  ...
  downloadExampleButton: ReactNode
}

export const UploadStep = ({ onContinue, downloadExampleButton }: UploadProps) => {
  ...
  return (
    <ModalBody>
      ...
      {downloadExampleButton && <Box sx={styles.exampleDiv}>{downloadExampleButton}</Box>}
